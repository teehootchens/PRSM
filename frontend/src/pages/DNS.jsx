...
export default function DNS() {
  ...
  const { chips, setChips, addChip, andMode, setAndMode } = usePageChips('dns_chips')
  ...
  return (
    <div>
      ...
      {!loading && <DataTable data={filteredData} columns={columns} onRefresh={() => setRefreshKey(k => k + 1)} defaultSort={[{ id: 'c2_over_dns_score', desc: true }]} onCellClick={addChip} />}
    </div>
  )
}
