...
export default function DNS() {
  ...
  const [sorting, setSorting] = useState([{ id: 'c2_over_dns_score', desc: true }])
  ...
  useEffect(() => {
    ...
    axios.get('/api/dns', { ...auth, params: { dataset, limit: 500 } })
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#7c85f5' }}>DNS Analysis</h1>
