...
export default function LongConns() {
  ...
  const [sorting, setSorting] = useState([{ id: 'long_conn_score', desc: true }])
  ...
  useEffect(() => {
    ...
    axios.get('/api/longconns', { ...auth, params: { dataset, limit: 500 } })
  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
        <h1 style={{ fontSize: '1.25rem', fontWeight: 700, color: '#7c85f5' }}>Long Connections</h1>
